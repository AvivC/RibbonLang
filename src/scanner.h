...
typedef enum {
    ...
    // Alphabetic symbols
    TOKEN_IF, TOKEN_ELSE, TOKEN_ELSIF, TOKEN_WHILE, TOKEN_AND, TOKEN_OR, TOKEN_RETURN,
	TOKEN_TRUE, TOKEN_FALSE, TOKEN_IMPORT, TOKEN_CLASS, TOKEN_NIL, TOKEN_FOR, TOKEN_IN, TOKEN_EXTERNAL,
