...
typedef enum {
    ...
    TOKEN_COMMA, TOKEN_NEWLINE, TOKEN_DOT, TOKEN_LEFT_SQUARE_BRACE, TOKEN_RIGHT_SQUARE_BRACE, TOKEN_COLON,
    
    // Two-character symbols
    TOKEN_EQUAL_EQUAL, TOKEN_BANG_EQUAL, TOKEN_GREATER_EQUAL, TOKEN_LESS_EQUAL,
    
    // Alphabetic symbols
    TOKEN_PRINT, TOKEN_END, TOKEN_IF, TOKEN_ELSE, TOKEN_ELSIF, TOKEN_WHILE, TOKEN_TAKES, TOKEN_TO, TOKEN_AND, TOKEN_OR, TOKEN_RETURN,
	TOKEN_TRUE, TOKEN_FALSE, TOKEN_IMPORT, TOKEN_CLASS, TOKEN_REF,
